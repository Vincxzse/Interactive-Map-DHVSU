...
export function createARM202(scene, worldWidth, worldHeight, playerPositionX, playerPositionY) {
    ...
    scene.ARM103Doormat1 = scene.physics.add.staticImage(200, worldHeight - 20, 'doormat1').setDisplaySize(50, 60).setDepth(1);
    scene.ARM103Doormat1.body.setOffset(0, 0);
    scene.ARM103Doormat1.refreshBody();
    scene.ARM103Doormat1.setAngle(90);

    scene.ARM103Doormat2 = scene.physics.add.staticImage(worldWidth - 200, worldHeight - 20, 'doormat1').setDisplaySize(50, 60).setDepth(1);
    scene.ARM103Doormat2.body.setOffset(0, 0);
    scene.ARM103Doormat2.refreshBody();
    scene.ARM103Doormat2.setAngle(90);
