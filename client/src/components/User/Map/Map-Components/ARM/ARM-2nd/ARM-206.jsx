...
export function createARM206(scene, worldWidth, worldHeight, playerPositionX, playerPositionY) {
    ...
    scene.ARM206Doormat1 = scene.physics.add.staticImage(70, 200, 'doormat1').setDisplaySize(50, 60).setDepth(1);
    scene.ARM206Doormat1.body.setOffset(0, 0);
    scene.ARM206Doormat1.refreshBody();

    scene.ARM206Doormat2 = scene.physics.add.staticImage(70, worldHeight - 100, 'doormat1').setDisplaySize(50, 60).setDepth(1);
    scene.ARM206Doormat2.body.setOffset(0, 0);
    scene.ARM206Doormat2.refreshBody();
