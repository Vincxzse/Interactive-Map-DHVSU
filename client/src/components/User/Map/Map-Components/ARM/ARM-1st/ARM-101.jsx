...
export function createARM101(scene, worldWidth, worldHeight, playerPositionX, playerPositionY) {
    ...
    scene.ARM101Doormat1 = scene.physics.add.staticImage(70, 200, 'doormat1').setDisplaySize(50, 60).setDepth(1);
    scene.ARM101Doormat1.body.setOffset(0, 0);
    scene.ARM101Doormat1.refreshBody();

    scene.ARM101Doormat2 = scene.physics.add.staticImage(70, worldHeight - 100, 'doormat1').setDisplaySize(50, 60).setDepth(1);
    scene.ARM101Doormat2.body.setOffset(0, 0);
    scene.ARM101Doormat2.refreshBody();
