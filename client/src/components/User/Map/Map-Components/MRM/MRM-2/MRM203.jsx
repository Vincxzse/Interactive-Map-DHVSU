...
export function createMRM203(scene, worldWidth, worldHeight, playerPositionX, playerPositionY) {
    ...
    scene.MRM203Exit1 = scene.physics.add.staticImage(200, 75, 'door-front').setDisplaySize(70, 70).setDepth(1);
    scene.MRM203Exit1.body.setOffset(0, 0);
    scene.MRM203Exit1.refreshBody();

    scene.MRM203Exit2 = scene.physics.add.staticImage(worldWidth - 200, 75, 'door-front').setDisplaySize(70, 70).setDepth(1);
    scene.MRM203Exit2.body.setOffset(0, 0);
    scene.MRM203Exit2.refreshBody();
