...
export function createMRM204(scene, worldWidth, worldHeight, playerPositionX, playerPositionY) {
    ...
    scene.MRM204Doormat1 = scene.physics.add.staticImage(70, 200, 'doormat1').setDisplaySize(50, 60).setDepth(1);
    scene.MRM204Doormat1.body.setOffset(0, 0);
    scene.MRM204Doormat1.refreshBody();
