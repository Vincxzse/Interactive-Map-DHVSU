...
export function createMRM201(scene, worldWidth, worldHeight, playerPositionX, playerPositionY) {
    ...
    scene.MRM201Exit1 = scene.physics.add.staticImage(200, 75, 'door-front').setDisplaySize(70, 70).setDepth(1);
    scene.MRM201Exit1.body.setOffset(0, 0);
    scene.MRM201Exit1.refreshBody();

    scene.MRM201Exit2 = scene.physics.add.staticImage(worldWidth - 200, 75, 'door-front').setDisplaySize(70, 70).setDepth(1);
    scene.MRM201Exit2.body.setOffset(0, 0);
    scene.MRM201Exit2.refreshBody();
