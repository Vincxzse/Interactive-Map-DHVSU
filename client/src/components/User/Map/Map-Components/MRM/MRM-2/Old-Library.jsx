...
export function createOldLibrary(scene, worldWidth, worldHeight, playerPositionX, playerPositionY) {
    ...
    scene.oldLibraryDoormat1 = scene.physics.add.staticImage(worldWidth - 70, 200, 'doormat1').setDisplaySize(50, 60).setDepth(1);
    scene.oldLibraryDoormat1.body.setOffset(0, 0);
    scene.oldLibraryDoormat1.refreshBody();
