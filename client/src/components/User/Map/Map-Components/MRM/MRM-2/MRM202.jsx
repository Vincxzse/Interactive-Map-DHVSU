...
export function createMRM202(scene, worldWidth, worldHeight, playerPositionX, playerPositionY) {
    ...
    scene.MRM202Exit1 = scene.physics.add.staticImage(200, 75, 'door-front').setDisplaySize(70, 70).setDepth(1);
    scene.MRM202Exit1.body.setOffset(0, 0);
    scene.MRM202Exit1.refreshBody();

    scene.MRM202Exit2 = scene.physics.add.staticImage(worldWidth - 200, 75, 'door-front').setDisplaySize(70, 70).setDepth(1);
    scene.MRM202Exit2.body.setOffset(0, 0);
    scene.MRM202Exit2.refreshBody();
