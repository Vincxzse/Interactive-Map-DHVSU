...
export function createFaculty(scene, worldWidth, worldHeight, playerPositionX, playerPositionY) {
    ...
    scene.facultyRoomDoormat1 = scene.physics.add.staticImage(70, 250, 'doormat1').setDisplaySize(50, 60).setDepth(1).setFlipX(true).setFlipY(true);
    scene.facultyRoomDoormat1.body.setOffset(0, 0);
    scene.facultyRoomDoormat1.refreshBody();

    scene.facultyRoomDoormat2 = scene.physics.add.staticImage(70, worldHeight - 50, 'doormat1').setDisplaySize(50, 60).setDepth(1).setFlipX(true).setFlipY(true);
    scene.facultyRoomDoormat2.body.setOffset(0, 0);
    scene.facultyRoomDoormat2.refreshBody();
